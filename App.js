...
export default function App() {
  return (
    ...
    //KeyboardAvoidingView: Comportamento de padding dos itens na tela;
    //TouchableWithoutFeedback: Desabilitar keybord quando usuario interagir com tela fora do espaço do keyboard;
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <Image
            source={require('./src/assets/InstaLogo.png')}
          />
          <TextInput
        ...
        <TouchableOpacity style={styles.facebookContainer}>
          <FontAwesome5 name= "facebook" size={25} color='#399FFF'/>
            <Text style={styles.facebookText}>Continue como...</Text>
        </TouchableOpacity>
